...
public class XMLTagProjectorTest {
  ...
  public void testOpeningNotEmptyMonotone() {
    Sentence source =
        new Sentence(
            ...
            new Tag[] {
              XMLTag.fromText("<b>", " ", null, 1), XMLTag.fromText("</b>", null, null, 2),
            });
  ...
  public void testOpeningNotEmptyNonMonotone() {
    ...
    assertArrayEquals(
        new Tag[] {
          XMLTag.fromText("<b>", null, null, 0), XMLTag.fromText("</b>", null, " ", 1),
        },
        translation.getTags());
  }
  ...
  public void testOpeningEmptyMonotone() {
    Sentence source =
        new Sentence(
            ...
            new Tag[] {
              XMLTag.fromText("<g>", " ", null, 1), XMLTag.fromText("</g>", null, null, 1),
            });
  ...
  public void testOpeningEmptyNonMonotone() {
    ...
    assertArrayEquals(
        new Tag[] {
          XMLTag.fromText("<g>", null, null, 0), XMLTag.fromText("</g>", null, null, 0),
        },
        translation.getTags());
  }
  ...
  public void testSpacedXMLCommentTags() {
    Sentence source =
        new Sentence(
            ...
            new Tag[] {
              XMLTag.fromText("<!--", " ", " ", 2), XMLTag.fromText("-->", " ", null, 4),
            });
  ...
  public void testNotSpacedXMLCommentTags() {
    Sentence source =
        new Sentence(
            ...
            new Tag[] {
              XMLTag.fromText("<!--", " ", null, 2), XMLTag.fromText("-->", null, null, 4),
            });
  ...
  public void testSingleXMLComment() {
    Sentence source =
        new Sentence(
            ...
            new Tag[] {
              XMLTag.fromText("<!--", null, null, 0), XMLTag.fromText("-->", null, null, 4),
            });
  ...
  public void testDTDTags() {
    ...
    Translation translation =
        new Translation(
            ...
            source,
            Alignment.fromAlignmentPairs(new int[][] {{0, 0}}));
  ...
  public void testOnlyTags() {
    Sentence source =
        new Sentence(
            null,
            new Tag[] {
              XMLTag.fromText("<a>", null, null, 0), XMLTag.fromText("</a>", null, null, 0),
            });
