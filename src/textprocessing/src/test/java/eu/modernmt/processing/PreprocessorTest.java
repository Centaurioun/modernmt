...
public class PreprocessorTest {
  ...
  private static Sentence process(LanguageDirection language, String text)
  ...
  public void testCommonSentence() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {w_("Hello"), _w("world"), w("!")}, sentence.getWords());
  }
  ...
  public void testInitialTagWithSpace() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {_w_("Hello"), _w("world"), w("!")}, sentence.getWords());
    assertArrayEquals(new Tag[] {t_("<a>", 0)}, sentence.getTags());
  }
  ...
  public void testStrippedSentenceWithSpaceAfterTag() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {w("Hello"), _w("world"), w("!")}, sentence.getWords());
    assertArrayEquals(new Tag[] {t_("<a>", 1)}, sentence.getTags());
  }
  ...
  public void testStrippedSentenceWithSpacesBetweenTags() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {w("Hello"), w("world"), w("!")}, sentence.getWords());
    assertArrayEquals(new Tag[] {t_("<a>", 1), _t("<b>", 1)}, sentence.getTags());
  }
  ...
  public void testRequiredSpaceTrue() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {w("Hello"), w("guys")}, sentence.getWords());
  ...
  public void testRequiredSpaceFalse() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {w("Hello"), w("!")}, sentence.getWords());
    assertArrayEquals(new Tag[] {t("<a>", 1)}, sentence.getTags());
  }
  ...
  public void testRequiredSpaceFalseWithRightSpace() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {w("Hello"), _w("!")}, sentence.getWords());
    assertArrayEquals(new Tag[] {t_("<a>", 1)}, sentence.getTags());
  }
  ...
  public void testRequiredSpaceFalseWithLeftSpace() throws ProcessingException {
    ...
    assertArrayEquals(new Word[] {w_("Hello"), w("!")}, sentence.getWords());
    assertArrayEquals(new Tag[] {_t("<a>", 1)}, sentence.getTags());
  }
  ...
  public void testTagAfterApostrophe() throws ProcessingException {
    ...
    assertArrayEquals(
        new Word[] {w_("Controlla"), _w("l'"), w("accesso"), _w_("al"), w("file"), w(".")},
        sentence.getWords());
    assertArrayEquals(
        new Tag[] {t("<b>", 2), t_("</b>", 3), _t("<i>", 4), t("</i>", 5)}, sentence.getTags());
  }
  ...
  public void testTagAroundApostrophe() throws ProcessingException {
    ...
    assertArrayEquals(
        new Word[] {w_("Controlla"), _w("l'"), w_("accesso"), _w_("al"), w("file"), w(".")},
        sentence.getWords());
    assertArrayEquals(
        new Tag[] {t("<b>", 2), t("</b>", 2), _t("<i>", 4), t("</i>", 5)}, sentence.getTags());
  }
}
