...
public class PostprocessorTest {
  private static final LanguageDirection language =
      new LanguageDirection(Language.ENGLISH, Language.ITALIAN);
  ...
  private static void test(
      String sourceText, String targetText, String alignText, String expected, String expectedNoTag)
  ...
  private static void test(
    ...
    postprocessor.process(
        language, translation, new Postprocessor.Options(language.source, language.target));
  ...
  public void testFrenchEnglishRequiredSpaces() throws Throwable {
    ...
    test(
        ...
        expectedOutput,
        expectedOutputNoTag,
        new LanguageDirection(Language.FRENCH, Language.ENGLISH));
  }
  ...
  public void testFrenchEnglishWithComplexAlignment() throws Throwable {
    String sourceStr =
        "A#A <LbxTag001>Par<LbxTag002>nature,<LbxTag003> l' atteinte<LbxTag004> de<LbxTag005>"
            + " ces<LbxTag006> objectifs est<LbxTag007> soumise<LbxTag008> à<LbxTag009>"
            + " de<LbxTag010> nombreux<LbxTag011> risques<LbxTag012> et<LbxTag013>"
            + " incertitudes<LbxTag014> susceptibles.<LbxTag015>";
    String targetStr =
        "A # A By nature , the achievement of these objectives is subject to many risks and"
            + " uncertainties .";
    String alignStr =
        "0-0 1-1 2-2 3-3 4-3 4-4 5-8 7-3 7-5 8-6 9-6 10-10 11-11 12-12 13-11 14-13 15-14 16-15"
            + " 17-16 17-17 18-17 19-18 19-17 20-18";

    String expectedOutput =
        "A#A <LbxTag001><LbxTag002><LbxTag003> By nature,<LbxTag004> <LbxTag005> the achievement of"
            + " these<LbxTag006> objectives<LbxTag007> <LbxTag008> is subject<LbxTag009>"
            + " to<LbxTag010> many<LbxTag011> risks<LbxTag012> and<LbxTag013> <LbxTag014>"
            + " uncertainties.<LbxTag015>";
    String expectedOutputNoTag =
        "A # A By nature, the achievement of these objectives is subject to many risks and"
            + " uncertainties.";
