...
/**
 * Tokenizes a sentence into words. Punctuation and whitespace gets their own tokens. The tokenizer
 * is a quite simple character-based one, though it knows about urls and will put them in one token,
...
public class WordTokenizer implements LanguageToolTokenizer {
  ...
  /**
   * @return The string containing the characters used by the tokenizer to tokenize words.
   * @since 2.5
   */
