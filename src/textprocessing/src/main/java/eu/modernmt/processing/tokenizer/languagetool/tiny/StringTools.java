...
class StringTools {
  ...
  /**
   * Checks if a string contains only whitespace, including all Unicode whitespace, but not the
   * non-breaking space. This differs a bit from the definition of whitespace in Java 7 because of
   * the way we want to interpret Khmer.
   *
   * @param str String to check
