...
public class Alignment {
  ...
  Alignment(eu.modernmt.model.Alignment a, int sourceWords, int targetWords) {
    ...
    // an additional position is reserved for (sourceWords+1) which is used for tags anchored to the
    // end of the sentence
    ...
    // create an artificial alignment point between positions (sourceWords) and (targetWords) (first
