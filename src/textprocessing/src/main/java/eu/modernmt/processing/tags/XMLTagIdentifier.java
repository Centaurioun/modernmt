 ...
 *
 * <p>An XMLTagIdentifier is the object that, in the processing pipeline, handles the identification
 * of XML Tags and requests to the StringBuider editor their replacement with a single white space.
 */
