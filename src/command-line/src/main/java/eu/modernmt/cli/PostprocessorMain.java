...
public class PostprocessorMain {
  ...
  private static class Args {
    ...
    static {
      ...
      Option postConfig =
          Option.builder().longOpt("postprocessor").hasArg().required(false).build();
    ...
    public Args(String[] args) throws ParseException {
      ...
      if ((source == null && alignment != null) || (source != null && alignment == null))
        throw new ParseException(
            "You must specify both '--source' and '--alignment' options or none of them");

      preConfigFile =
          cli.hasOption("preprocessor") ? new File(cli.getOptionValue("preprocessor")) : null;
      postConfigFile =
          cli.hasOption("postprocessor") ? new File(cli.getOptionValue("postprocessor")) : null;
    }
  }
  ...
  public static void main(String[] _args) throws Throwable {
    ...
    try {
      translations =
          new TranslationProvider(args.language, args.source, args.alignment, args.preConfigFile);
      postprocessor = new Postprocessor();

      if (args.postConfigFile != null) {
        XMLPipelineBuilder<Translation, Void> builder =
            XMLPipelineBuilder.loadFromXML(args.postConfigFile);
      ...
      Postprocessor.Options options =
          new Postprocessor.Options(args.language.source, args.language.target);
  ...
  private static class TranslationProvider implements Closeable {
    ...
    public TranslationProvider(
        LanguageDirection language, File source, File alignment, File configFile)
        ...
        try {
          if (configFile != null) {
            XMLPipelineBuilder<String, Sentence> builder =
                XMLPipelineBuilder.loadFromXML(configFile);
    ...
    public Translation next() throws IOException {
      ...
      if (sources != null) {
        ...
        if (sourceStr == null || alignmentStr == null) throw new IOException("Unexpected EOF");
