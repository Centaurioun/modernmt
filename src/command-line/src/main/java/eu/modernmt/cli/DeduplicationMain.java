...
public class DeduplicationMain {
  ...
  public static void main(String[] _args) throws Throwable {
    ...
    if (args.target == null) {
      ...
      ModernMT.training.deduplicateMonolingual(
          corpora, args.outputRoot, args.lengthThreshold, args.sortBy != null);
    } else {
  ...
  private static class CorporaComparator {
    ...
    private int getPriority(String name) {
      for (int i = 0; i < priorityArray.length; i++) {
        if (name.contains(priorityArray[i])) return i;
      }
  ...
  private static class MonolingualCorporaComparator extends CorporaComparator
      implements Comparator<Corpus> {
  ...
  private static class MultilingualCorporaComparator extends CorporaComparator
      implements Comparator<MultilingualCorpus> {
    ...
    public int compare(MultilingualCorpus o1, MultilingualCorpus o2) {
      return super.compare(
          o1.getName(), o1.getLineCount(language), o2.getName(), o2.getLineCount(language));
    }
  }
}
