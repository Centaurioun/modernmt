...
public class Translate extends ObjectAction<TranslationResponse> {
  ...
  @Override
  protected TranslationResponse execute(RESTRequest req, Parameters _params)
      throws ContextAnalyzerException, DecoderException, ProcessingException {
    ...
    if (params.context != null) {
      ...
      result.context =
          ModernMT.translation.getContextVector(
              params.user, params.direction, params.contextString, params.contextLimit);
      result.translation =
          ModernMT.translation.get(
              params.user,
              params.direction,
