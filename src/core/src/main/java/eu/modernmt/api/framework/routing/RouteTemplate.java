...
public class RouteTemplate {
  ...
  public RouteTemplate(String template, Class<? extends Action> actionClass, HttpMethod method) {
  ...
  //
  //    public <T extends Enum<T>> T getEnum(RESTRequest req, String varName, Class<T> clazz) throws
  // TemplateException {
  ...
  //    }
  //
  //    public <T extends Enum<T>> T getEnum(RESTRequest req, String varName, Class<T> clazz, T def)
