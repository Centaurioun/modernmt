...
public class UpdateMemoryContribution extends ObjectAction<ImportJob> {
  ...
  protected ImportJob execute(RESTRequest req, Parameters _params)
    ...
    if (params.previousSentence != null && params.previousTranslation != null)
      return ModernMT.memory.replace(
          params.memory, params.tu, params.previousSentence, params.previousTranslation);
    else return ModernMT.memory.replace(params.memory, params.tu);
  }
