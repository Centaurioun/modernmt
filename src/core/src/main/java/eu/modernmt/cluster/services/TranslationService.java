 ...
 * It allows cluster members to ask to other cluster members to perform translations; translations,
 * moreover, will be run taking their priority into account.
 *
 * <p>As always in Hazelcast Services, this service is reached by cluster members through local
 * proxies.
 *
 * @see TranslationServiceProxy
 *     <p>This TranslationService is typically initialized at cluster start.
 */
