...
/**
 * Created by davide on 25/12/16. Updated by andrearossi on 29/03/17 Wrapper for TopicPartition: it
 * is used to assign an id to a TopicPartition
 */
public class KafkaChannel implements LogChannel {
  ...
  /**
   * It initializes a new TopicPartition with the given topic name and partition number 0
   *
   * <p>NOTE: In a TopicPartition, we ALWAYS use partition 0 only
   *
