...
public class PartitioningUtils {
  ...
  public static double getAdjustedWeight(
      LanguageDirection language,
      MultilingualCorpus corpus,
      long extraPartitionsLines,
      long corporaLines) {
  ...
  public static long countTotalPartitionsLines(Collection<CorporaPartition> partitions) {
    ...
    for (CorporaPartition partition : partitions) count += partition.getSize();
