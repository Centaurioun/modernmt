...
public class BackupEngine {
  ...
  public void start() throws BootstrapException {
    ...
    for (LogDataListener listener : engine.getDataListeners()) binlog.addLogDataListener(listener);
  ...
  public void stop(boolean optimize) throws IOException {
    ...
    if (binlogError != null) throw binlogError;
    if (engineError != null) throw engineError;
