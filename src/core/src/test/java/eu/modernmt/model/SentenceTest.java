...
public class SentenceTest {
  ...
  public void testCommonSentence() {
    Sentence sentence =
        new Sentence(
            new Word[] {
              new Word("Hello", null, " "), new Word("world", " ", null), new Word("!", null, null),
            });
  ...
  public void testInitialTagWithSpace() {
    Sentence sentence =
        new Sentence(
            ...
            new Tag[] {XMLTag.fromText("<a>", null, " ", 0)});
  ...
  public void testStrippedSentenceWithSpaceAfterTag() {
    Sentence sentence =
        new Sentence(
            new Word[] {
              new Word("Hello", null, null, false, true), new Word("world", " ", null, true, false),
            },
            new Tag[] {XMLTag.fromText("<a>", null, " ", 1)});
  ...
  public void testStrippedSentenceWithSpacesBetweenTags() {
    Sentence sentence =
        new Sentence(
            ...
            new Tag[] {XMLTag.fromText("<a>", null, " ", 1), XMLTag.fromText("<b>", " ", null, 1)});
  ...
  public void testStrippedSentenceWithoutSpacesBetweenTags() throws ProcessingException {
    Sentence sentence =
        new Sentence(
            ...
            new Tag[] {
              XMLTag.fromText("<a>", null, null, 1), XMLTag.fromText("<b>", null, null, 1)
            });
