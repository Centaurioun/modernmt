...
public class MockMultilingualCorpus extends BaseMultilingualCorpus {
  ...
  private static final LanguageDirection MOCK_LANGUAGE =
  ...
  public static TranslationUnit tu(String source, String target, long date) {
    return new TranslationUnit(
        null, MOCK_LANGUAGE, source, target, new Date(MOCK_EPOCH + (date * 60L * 1000L)));
  }
  ...
  public String toString() {
    ...
    for (TranslationUnit tu : tus) {
      ...
      builder.append('(');
      if (tu.timestamp != null) builder.append(tu.timestamp.toString());
      builder.append(')');
      builder.append(' ');
    }
