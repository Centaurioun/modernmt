...
public class TestData {
  ...
  public static final LanguageDirection EN_US__FR_CA =
      new LanguageDirection(TestData.EN_US, TestData.FR_CA);
  ...
  public static List<TranslationUnitMessage> additions(
  ...
  public static TranslationUnit tu(
      String tuid, LanguageDirection language, String source, String target) {
    return new TranslationUnit(tuid, language, source, target, new Date());
  }

  public static DeletionMessage deletion(
      int channel, long channelPosition, long memory, UUID owner) {
    return new DeletionMessage((short) channel, channelPosition, owner, memory);
  }

  public static TranslationUnitMessage addition(
      int channel, long channelPosition, long memory, TranslationUnit tu) {
    return addition(channel, channelPosition, memory, null, tu);
  }

  public static TranslationUnitMessage addition(
      int channel, long channelPosition, long memory, UUID owner, TranslationUnit tu) {
  ...
  public static TranslationUnitMessage overwrite(
      int channel, long channelPosition, long memory, TranslationUnit tu) {
  ...
  public static TranslationUnitMessage overwrite(
    ...
    return overwrite(
        channel, channelPosition, memory, null, tu, previousSentence, previousTranslation);
  }
  ...
  public static MultilingualCorpus corpus(String name, List<TranslationUnitMessage> units) {
    final HashMap<LanguageDirection, ArrayList<TranslationUnitMessage>> lang2units =
        new HashMap<>();
