...
public class TestLuceneTranslationMemory_search {
  ...
  public void setup() throws Throwable {
    ...
    List<TranslationUnitMessage> units1 =
        Arrays.asList(
    ...
    List<TranslationUnitMessage> units2 =
        Arrays.asList(
  ...
  private static boolean contains(
      ...
      String translation) {
    ScoreEntry target =
        new ScoreEntry(memory, direction, sentence.split(" "), translation.split(" "));
  ...
  public void directSearchWithItalianHelloWorld() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, EN__IT, TestData.sentence("Hello world"), context, 100);
  ...
  public void directSearchWithItalianTheTest() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, EN__IT, TestData.sentence("The test"), context, 100);
  ...
  public void directSearchWithItalianDialect() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, EN_US__IT_CH, TestData.sentence("Hello world"), context, 100);
  ...
  public void reversedSearchWithItalianHelloWorld() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, IT__EN, TestData.sentence("Ciao mondo"), context, 100);
  ...
  public void reversedSearchWithItalianTheTest() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, IT__EN, TestData.sentence("Il test"), context, 100);
  ...
  public void reversedSearchWithItalianDialect() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, IT_CH__EN_US, TestData.sentence("Ciao mondo"), context, 100);
  ...
  public void directSearchWithFrenchHelloWorld() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, EN__FR, TestData.sentence("Hello world"), context, 100);
  ...
  public void directSearchWithFrenchDialect() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, EN_US__FR_CA, TestData.sentence("Hello world"), context, 100);
  ...
  public void reversedSearchWithFrenchHelloWorld() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, FR__EN, TestData.sentence("Bonjour monde"), context, 100);
  ...
  public void reversedSearchWithFrenchDialect() throws Throwable {
    ScoreEntry[] result =
        this.memory.search(null, FR_CA__EN_US, TestData.sentence("Bonjour monde"), context, 100);
