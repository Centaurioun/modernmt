...
public interface Scheduler extends Closeable {
  ...
  /**
   * Schedule a group of translation splits (from one single translation) to be translated at some
   * point in the future.
   *
   ...
   * @return a {@link TranslationLock} that will unlock when all the translation splits have
   *     completed
   * @throws DecoderUnavailableException if there are too many pending translation jobs or the
   *     Scheduler has been closed
   */
  TranslationLock schedule(
      LanguageDirection direction, TranslationSplit[] splits, ScoreEntry[] suggestions)
      throws DecoderUnavailableException;

  /**
   * Schedule a a single translation split to be aligned with the given translation at some point in
   * the future.
   *
   ...
   *     Scheduler has been closed
   */
  TranslationLock schedule(LanguageDirection direction, TranslationSplit split)
      throws DecoderUnavailableException;
