...
class Handler implements PythonDecoder {
  ...
  public void restart() throws IOException {
    ...
    if (gpu < 0) delegate = builder.startOnCPU();
    else delegate = builder.startOnGPU(gpu);
  }
  ...
  @Override
  public synchronized Translation translate(
      LanguageDirection direction, Sentence sentence, int nBest) throws DecoderException {
    if (delegate == null) throw new DecoderUnavailableException("Decoder process is dead");
  ...
  @Override
  public synchronized Translation align(
      LanguageDirection direction, Sentence sentence, String[] translation)
      throws DecoderException {
    if (delegate == null) throw new DecoderUnavailableException("Decoder process is dead");
