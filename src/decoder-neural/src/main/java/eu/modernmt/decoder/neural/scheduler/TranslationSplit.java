...
public class TranslationSplit {
  ...
  public TranslationSplit(
      Priority priority, Sentence sentence, String[] reference, long expiration) {
  ...
  public void setTranslation(Translation translation) {
    ...
    if (this.lock != null) this.lock.translationSplitCompleted(this);
  }
  ...
  public Translation getTranslation() throws DecoderException {
    if (exception == null) return translation;
    else if (exception instanceof RuntimeException) throw (RuntimeException) exception;
    else if (exception instanceof DecoderException) throw (DecoderException) exception;
    else throw new DecoderException("Unexpected error: " + exception.getMessage(), exception);
  }
