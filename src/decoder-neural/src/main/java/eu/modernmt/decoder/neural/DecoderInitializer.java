...
public interface DecoderInitializer {
  ...
  TranslationMemory createTranslationMemory(
      DecoderConfig config, ModelConfig modelConfig, File model) throws IOException;

  DecoderQueue createDecoderQueue(DecoderConfig config, ModelConfig modelConfig, File model)
      throws DecoderException;

  Scheduler createScheduler(DecoderConfig config, ModelConfig modelConfig, int queueSize)
      throws DecoderException;

  DecoderExecutor createDecoderExecutor(DecoderConfig config, ModelConfig modelConfig)
      throws DecoderException;
}
