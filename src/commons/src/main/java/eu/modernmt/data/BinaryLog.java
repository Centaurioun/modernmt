...
public interface BinaryLog extends Closeable {
  ...
  ImportJob upload(Memory memory, MultilingualCorpus corpus, short channel)
      throws BinaryLogException;

  ImportJob upload(Memory memory, MultilingualCorpus corpus, LogChannel channel)
      throws BinaryLogException;
  ...
  ImportJob replace(Memory memory, TranslationUnit tu, LogChannel channel)
      throws BinaryLogException;
