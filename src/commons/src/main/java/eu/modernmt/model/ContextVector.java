...
public class ContextVector implements Iterable<ContextVector.Entry>, Serializable {
  ...
  public static class Builder {
    ...
    public Builder add(Memory memory, float score) {
      if (score > 0.f) entries.put(memory, score);
      return this;
    }
  ...
  public static ContextVector fromString(String string) throws IllegalArgumentException {
    ...
    for (String element : elements) {
      ...
      if (kv.length != 2) throw new IllegalArgumentException(string);
      ...
      try {
        ...
        if (idx < 0) {
          ...
          if (uc.length != 2) throw new IllegalArgumentException(string);
      ...
      if (id < 1) throw new IllegalArgumentException(string);

      if (score < 0.f || score > 1.f) throw new IllegalArgumentException(string);
