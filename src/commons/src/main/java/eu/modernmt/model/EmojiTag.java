...
public class EmojiTag extends Tag {
  ...
  public static final Pattern TagRegex =
      Pattern.compile(
          "[\\x{00002700}-\\x{000027ff}\\x{00002900}-\\x{0000297f}\\x{00002b00}-\\x{00002bff}\\x{0001f000}-\\x{0001f265}\\x{0001f300}-\\x{0001f64f}\\x{0001f680}-\\x{0001f6ff}\\x{0001f7e0}-\\x{0001f7eb}\\x{0001f800}-\\x{0001f8ff}\\x{0001f900}-\\x{0001f9ff}\\x{0001fa70}-\\x{0001fa95}]+");

  private static final String NAME = "EmojiTag";

  public static EmojiTag fromText(String text) {
  ...
  private EmojiTag(
      String name, String text, String leftSpace, String rightSpace, int position, Tag.Type type) {
