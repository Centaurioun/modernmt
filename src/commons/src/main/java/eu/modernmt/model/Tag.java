...
public abstract class Tag extends Token implements Comparable<Tag>, Cloneable {
  ...
  */
  ...
  protected Tag(
      String name, String text, String leftSpace, String rightSpace, int position, Type type) {
