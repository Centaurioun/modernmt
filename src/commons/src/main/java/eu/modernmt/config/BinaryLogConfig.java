...
/**
 * Created by davide on 04/01/17. Updated by andrearossi on 03/04/17
 *
 * <p>This class embodies a configuration for a BinaryLog. It may be read from a configuration file
 * (e.g. engineConf.xml) (or obtained in some different way)
 */
