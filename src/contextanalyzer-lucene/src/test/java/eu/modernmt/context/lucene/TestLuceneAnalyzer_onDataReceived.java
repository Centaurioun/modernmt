...
public class TestLuceneAnalyzer_onDataReceived {
  ...
  public void teardown() throws Throwable {
    if (this.analyzer != null) this.analyzer.close();
    this.analyzer = null;
  }
  ...
  public void directMixedMemories() throws Throwable {
    ...
    List<TranslationUnitMessage> units2 =
        Arrays.asList(TestData.tu(0, 4L, 2L, IT__EN, null), TestData.tu(0, 5L, 2L, EN__FR, null));
  ...
  public void duplicateContribution() throws Throwable {
    List<TranslationUnitMessage> units =
        Arrays.asList(TestData.tu(1, 0L, 1L, EN__IT, null), TestData.tu(1, 1L, 1L, EN__IT, null));

    List<TranslationUnitMessage> cloneUnits =
        Arrays.asList(TestData.tu(1, 0L, 2L, EN__FR, null), TestData.tu(1, 1L, 2L, EN__FR, null));
