...
public class TestData {
  ...
  public static final LanguageDirection EN_US__IT =
      new LanguageDirection(TestData.EN_US, TestData.IT);
  public static final LanguageDirection EN_US__IT_CH =
      new LanguageDirection(TestData.EN_US, TestData.IT_CH);
  public static final LanguageDirection IT_CH__EN_US =
      new LanguageDirection(TestData.IT_CH, TestData.EN_US);
  public static final LanguageDirection IT__EN_US =
      new LanguageDirection(TestData.IT, TestData.EN_US);
  public static final LanguageDirection FR_CA__EN_US =
      new LanguageDirection(TestData.FR_CA, TestData.EN_US);
  ...
  static {
    ...
    EXAMPLE_CONTENTS.put(
        "en",
        "If Parliament and the Commission work together real progress can be made in 'cleaning up'"
            + " the Commission.\n"
            + "If this does not happen the college of Commissioners will cease to have my"
            + " support.\n"
            + "He who is not punished for a greater crime will be punished for a lesser crime.\n"
            + "Contaminated feed continued to be in circulation, and the European Commission still"
            + " said nothing.\n"
            + "Several tens of cases of Creutzfeldt-Jacob's disease were declared, condemning young"
            + " Europeans because the cattle disease had perhaps been transmitted to humans.\n"
            + "In any case, the risk was knowingly taken to contaminate millions of human beings.\n"
            + "This was done by the European Commission. This health risk was taken by the"
            + " Commission.\n"
            + "Let us not mince our words: in this affair the Commission's attitude was more than"
            + " negligent, it was an irresponsible and criminal attitude.\n"
    ...
    EXAMPLE_CONTENTS.put(
        ...
        "Se Parlamento e Commissione collaboreranno, potremo veramente «ripulire» la Commissione.\n"
            ...
            + "Sono ancora in circolazione farine contaminate e la Commissione europea non dice"
            + " nulla.\n"
            + "Sono state denunciate decine di casi della sindrome di Creutzfeldt-Jacob, che ha"
            + " colpito giovani europei, perché la malattia della mucca pazza può essere trasmessa"
            + " all'uomo.\n"
            + "In definitiva, si è corso volontariamente il rischio di contaminare milioni di"
            + " esseri umani.\n"
            + "Ecco cosa ha fatto la Commissione europea: ha corso un tale rischio sanitario.\n"
            + "Chiamiamo le cose con il loro nome: la Commissione in questo caso non è stata"
            + " negligente, ma ha avuto un atteggiamento totalmente irresponsabile e criminale.\n"
            + "Il Parlamento europeo non ha preso provvedimenti all'epoca.\n"
            + "Anche in questo caso, non vi fu alcuna sanzione.");
    EXAMPLE_CONTENTS.put(
        "fr",
        "Si le Parlement et la Commission travaillent ensemble, des progrès réels peuvent être"
            + " réalisés dans le «nettoyage» de la Commission.\n"
            + "Si cela n'arrive pas, le collège des commissaires cessera d'avoir mon soutien.\n"
            + "Celui qui n'est pas puni pour un crime majeur sera puni pour un crime de moindre"
            + " importance.\n"
            + "Les aliments contaminés continuent d'être en circulation, et la Commission"
            + " européenne n'a toujours rien dit.\n"
            + "Plusieurs dizaines de cas de maladie de Creutzfeldt-Jacob ont été déclarés,"
            + " condamnant les jeunes Européens parce que la maladie du bétail avait peut-être été"
            + " transmise aux humains.\n"
            + "En tout cas, le risque a été sciemment pris pour contaminer des millions d'êtres"
            + " humains.\n"
            + "Cela a été fait par la Commission européenne. Ce risque pour la santé a été pris par"
            + " la Commission.\n"
            + "Ne tenons pas nos mots: dans cette affaire, l'attitude de la Commission était plus"
            + " que négligente, c'était une attitude irresponsable et criminelle.\n"
    ...
    EXAMPLE_TERMS.put(
        ...
        new HashSet<>(
            Arrays.asList(
                ("college been creutzfeldt mince several had parliament transmitted negligent"
                     + " either lesser punish than let affair up because criminal greater case us"
                     + " happen still work made european nothing cattle real my done condemning"
                     + " feed were europeans contaminated millions support who attitude tens young"
                     + " our can perhaps does taken irresponsible have commission crime punished"
                     + " said jacob human together contaminate cleaning declared commissioners"
                     + " cases disease more words continued health yet any beings punishment cease"
                     + " circulation progress risk he humans did knowingly")
                    .split(" "))));
    EXAMPLE_TERMS.put(
        "it",
        new HashSet<>(
            Arrays.asList(
                ("contaminare irresponsabile negligente creutzfeldt censurato stata dice europea"
                     + " commissari ancora uomo può tale cose provvedimenti offrirò cosa caso"
                     + " definitiva parlamento circolazione sanitario ripulire casi state chiamiamo"
                     + " fatto sindrome volontariamente commissione ecco nome colpito totalmente"
                     + " altrimenti epoca criminale denunciate corso pazza trasmessa essere potremo"
                     + " rischio giovani malattia esseri jacob contaminate collegio preso milioni"
                     + " umani sostegno grande mucca piccolo europei atteggiamento farine veramente"
                     + " collaboreranno alcuna sanzione viene europeo decine nulla")
                    .split(" "))));
  }
  ...
  public static Sentence sentence(String text) {
    ...
    for (int i = 0; i < words.length; i++) words[i] = new Word(tokens[i], " ", " ");
  ...
  public static List<TranslationUnitMessage> tuList(
      long memory, LanguageDirection language, int size) {
    return tuList(0, 0L, memory, language, size);
  }

  public static List<TranslationUnitMessage> tuList(
      int channel, long channelPosition, long memory, LanguageDirection language, int size) {
  ...
  public static TranslationUnitMessage tu(
      int channel, long channelPosition, long memory, LanguageDirection language, Date timestamp) {
    return tu(
        channel,
        channelPosition,
        memory,
  ...
  public static TranslationUnitMessage tu(
      LanguageDirection language, String source, String target, Date timestamp) {
    return tu(1L, language, source, target, timestamp);
  }

  public static TranslationUnitMessage tu(
      long memory, LanguageDirection language, String source, String target, Date timestamp) {
  ...
  public static TranslationUnitMessage tu(
    ...
    return new TranslationUnitMessage(
        (short) channel,
        channelPosition,
        memory,
        owner,
  ...
  public static Set<String> tuGetTerms(List<TranslationUnitMessage> units, boolean source)
      throws IOException {
    return tuGetTerms(units, source, null);
  }

  public static Set<String> tuGetTerms(
      List<TranslationUnitMessage> units, boolean source, LanguageDirection direction)
      throws IOException {
  ...
  public static String tuGetContent(
      List<TranslationUnitMessage> units, boolean source, LanguageDirection direction) {
  ...
  public static Set<String> getTerms(Language... locales) {
    HashSet<String> terms = new HashSet<>();
    for (Language locale : locales) terms.addAll(EXAMPLE_TERMS.get(locale.getLanguage()));
  ...
  public static DummyBilingualCorpus corpus(
      String name, LanguageDirection direction, String sourceContent, String targetContent) {
  ...
  public static class DummyBilingualCorpus extends BaseMultilingualCorpus {
    ...
    public Corpus getCorpus(LanguageDirection language, boolean source) {
      if (!language.equals(this.language)) throw new UnsupportedLanguageException(language);
    ...
    public TUReader getContentReader() {
      return new TUReader() {
        ...
        public TranslationUnit read() throws IOException {
          ...
          while (tu == null) {
            if (reader == null) {
              if (index < corpora.length) reader = corpora[index++].getContentReader();
              else return null;
            }
